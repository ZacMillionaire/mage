...
<div class="dashboard-message">
	...
	<a href="/mage/research/<?php echo self::$pageData["researchEntryLink"]; ?>">View Updated Entry</a>
</div>
<?php } ?>

<?php if(@isset(self::$pageData["updatePreview"])){ ?>
<div class="article-preview">
	<div class="header title">
		<h1>Update Preview</h1>
	</div>
	<div class="article-container">
		<?php echo self::$pageData["updatePreview"]; ?>
	</div>
</div>
<?php } ?>
...
<div class="form-section">
	...
	<form action="/mage/dashboard/research/update/<?php echo @self::$pageData["researchEntryData"]["researchID"]; ?>" method="POST">
		...
		<div class="form-input">
			...
			echo (isset($_POST["updateTitle"])) ? $_POST["updateTitle"] : null; ?></textarea>
		</div>
